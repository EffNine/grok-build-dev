...
> Requires a published [GitHub Release](https://github.com/effnine/grok-build-dev/releases) with `grok-{version}-{os}-{arch}` assets. Tag `vX.Y.Z` (or run the **Release** workflow) to publish one. Latest with binaries: **v0.2.108**.
